...
async function getServices(endpoint) {
...
async function getAllServices() {
  const [medicalServices, clinicalServices, surgicalServices] =
    await Promise.all([
      getServices("/api/facility/hospital/medical-service"),
      getServices("/api/facility/hospital/clinical-service"),
      getServices("/api/facility/hospital/surgical-service"),
    ]);
...
function SectionHeading({ number, title }) {
  return (
    <div className="flex items-center justify-center gap-4 sm:gap-5 lg:gap-[30px]">
      <span
        className="
          shrink-0
          font-['Bitter']
      ...
      <div className="flex w-full flex-col gap-[5px]">
        <h3
          className={`
            ...
            ${featured ? "text-white" : "text-[#018837]"}
          `}
        >
          {service.title}
        </h3>
        ...
        <p
          className={`
            ...
            ${featured ? "text-white/90" : "text-[#444444]"}
          `}
        >
          {service.description}
        </p>
...
function SideHeading({ title, icon, position = "left" }) {
  const isLeft = position === "left";
  ...
  return (
    ...
    >
      {isLeft && (
        <div className="relative hidden h-[100px] w-[100px] shrink-0 lg:block">
          <Image
            src={icon}
            alt=""
            fill
...
function ClinicalServiceGrid({ services }) {
  return (
    <div className="grid flex-1 grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-6">
...
export default async function MedicalService() {
  const { medicalServices, clinicalServices, surgicalServices } =
            ...
            >
              ...
              >
                ...
                <SideHeading
                  ...
                  icon={clinicalServices[0]?.image}
                  position="left"
                />

                {/* CARDS */}

                <ClinicalServiceGrid services={clinicalServices} />
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                <div className="order-1 flex-1">
                  <ClinicalServiceGrid services={surgicalServices} />
                </div>
