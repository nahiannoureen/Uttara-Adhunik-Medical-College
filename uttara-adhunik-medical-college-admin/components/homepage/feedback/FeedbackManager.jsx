  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/api/homepage/feedback/${id}`,
        {
          method: "DELETE",
        },
      );
  ...
  const handleSubmit = async (formData) => {
    ...
    try {
      const url = editingFeedback
        ? `${process.env.NEXT_PUBLIC_API_URL}/api/homepage/feedback/${editingFeedback._id}`
        : `${process.env.NEXT_PUBLIC_API_URL}/api/homepage/feedback`;
