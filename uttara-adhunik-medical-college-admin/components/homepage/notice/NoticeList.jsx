...
export default function NoticeList({ notices, onEdit, onDelete, isDeleting }) {
  const [imageErrors, setImageErrors] = useState({});

  const handleImageError = (noticeId) => {
    setImageErrors((prev) => ({ ...prev, [noticeId]: true }));
  };
        ...
        >
          ...
          <div className="p-4">
            ...
            <div className="flex items-center justify-between text-xs text-gray-400 mb-4">
              <span>ID: {notice._id.slice(-6)}</span>
              <span>
