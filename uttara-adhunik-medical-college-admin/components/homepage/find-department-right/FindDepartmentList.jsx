...
export default function FindDepartmentList({
  department,
  onEdit,
  onDelete,
  isDeleting,
  ...
  const handleImageError = (departmentId) => {
    setImageErrors((prev) => ({ ...prev, [departmentId]: true }));
  };
      ...
      {department.map((department) => (
        ...
        >
          ...
          <div className="relative h-48 w-full bg-gray-100">
            {!imageErrors[department._id] ? (
              <Image
                src={department.image1}
                alt={department.title}
                fill
                className="object-cover"
                onError={() => handleImageError(department._id)}
            ...
            {department.image?.includes("cloudinary") && (
          ...
          <div className="p-4">
            ...
            {/* CTA Display */}
            {department.cta && (department.cta.text || department.cta.href) && (
            ...
            <div className="flex items-center justify-between text-xs text-gray-400 mb-4">
              <span>ID: {department._id.slice(-6)}</span>
              <span>
