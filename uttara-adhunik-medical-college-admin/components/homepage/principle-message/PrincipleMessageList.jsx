...
export default function PrincipleMessageList({
  message,
  onEdit,
  onDelete,
  isDeleting,
    ...
    return (
      <div className="text-center py-12 bg-gray-50 rounded-lg">
        <p className="text-gray-500 text-lg">
          No message found. Add your first message!
        </p>
      </div>
    );
  }
      ...
      {message.map((message) => (
        ...
        >
          ...
          <div className="relative h-48 w-full bg-gray-100">
            ...
            {message.image1?.includes("cloudinary") && (
          ...
          <div className="relative h-48 w-full bg-gray-100">
            ...
            {/* Cloudinary Badge (optional) */}
            {message.image2?.includes("cloudinary") && (
              <div className="absolute top-2 right-2 bg-blue-500 text-white text-xs px-2 py-1 rounded-full">
                Cloudinary
              </div>
            )}
          ...
          <div className="p-4">
            ...
            {/* CTA Display */}
            {message.cta && (message.cta.text || message.cta.href) && (
