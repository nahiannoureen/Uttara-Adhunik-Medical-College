  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/api/homepage/about/${id}`,
        {
          method: "DELETE",
        },
      );
  ...
  const handleSubmit = async (formData) => {
    ...
    try {
      const url = editingAbout
        ? `${process.env.NEXT_PUBLIC_API_URL}/api/homepage/about/${editingAbout._id}`
        : `${process.env.NEXT_PUBLIC_API_URL}/api/homepage/about`;
