...
import EligibilityList from "@/components/admission/procedure-and-fee/eligibility-foreign-student/EligibilityList";
import { useForeignStudentEligibilityData } from "@/lib/DataFetch/Admission/Procedure/SWRDataFetch";
import EligibilityForm from "@/components/admission/procedure-and-fee/eligibility-foreign-student/EligibilityForm";
...
export default function FacilityManager() {
  const {
    ...
    mutate,
    isLoading,
  } = useForeignStudentEligibilityData();
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/api/admission/procedure-and-fee/eligibility-foreign-student/${id}`,
        {
          method: "DELETE",
        },
      );
