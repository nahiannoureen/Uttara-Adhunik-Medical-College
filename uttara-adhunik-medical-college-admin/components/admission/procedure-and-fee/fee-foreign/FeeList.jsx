...
export default function FeeList({ feature, onEdit, onDelete, isDeleting }) {
  if (!feature) {
    return (
    ...
    return (
      <div className="text-center py-12 bg-gray-50 rounded-lg">
        ...
        <p className="text-gray-500 text-lg">
          No Fee found for Foreign student. Add your first Fee for foreign
          student.
        </p>
      </div>
    );
              ...
              >
                ...
                >
                  <path
                    ...
                    strokeWidth={2}
                    d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2h-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"
                  />
                </svg>
                Edit
              </button>
