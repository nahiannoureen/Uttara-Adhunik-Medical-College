...
import DocumentList from "@/components/admission/procedure-and-fee/document/DocumentList";
import { useForeignDocumentData } from "@/lib/DataFetch/Admission/Procedure/SWRDataFetch";
import DocumentForm from "@/components/admission/procedure-and-fee/document/DocumentForm";
import Modal from "@/components/ui/Modal";
import { toast } from "sonner";

export default function DocumentManager() {
  const { data: feature, mutate, isLoading } = useForeignDocumentData();
  ...
  const handleDelete = async (id) => {
    if (!confirm("Are you sure you want to delete this required document?"))
      return;
    ...
    try {
      ...
      toast.success(
        editingFeature
          ...
          : "Required document added successfully!",
      );
      mutate(); // Refresh the data
  ...
  return (
    <div className="">
      ...
      <Modal
        ...
        title={editingFeature ? "Edit document" : "Add New document"}
      >
        <DocumentForm
