...
import EligibilityList from "@/components/admission/procedure-and-fee/eligibility-national-student/EligibilityList";
import { useEligibilityData } from "@/lib/DataFetch/Admission/Procedure/SWRDataFetch";
import EligibilityForm from "@/components/admission/procedure-and-fee/eligibility-national-student/EligibilityForm";
import Modal from "@/components/ui/Modal";
import { toast } from "sonner";

export default function FacilityManager() {
  const { data: feature, mutate, isLoading } = useEligibilityData();
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/api/admission/procedure-and-fee/eligibility-national-student/${id}`,
        {
          method: "DELETE",
        },
      );
  ...
  return (
    <div className="">
      ...
      <Modal
        ...
        title={editingFeature ? "Edit Description" : "Add New Description"}
      >
        <EligibilityForm
