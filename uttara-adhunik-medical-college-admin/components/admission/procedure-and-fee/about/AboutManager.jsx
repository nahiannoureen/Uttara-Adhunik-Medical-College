...
import AboutList from "@/components/admission/procedure-and-fee/about/AboutList";
import { useAboutData } from "@/lib/DataFetch/Admission/Procedure/SWRDataFetch";
import AboutForm from "@/components/admission/procedure-and-fee/about/AboutForm";
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/api/admission/procedure-and-fee/about/${id}`,
        {
          method: "DELETE",
        },
      );
  ...
  const handleSubmit = async (formData) => {
    ...
    try {
      const url = editingAbout
        ? `${process.env.NEXT_PUBLIC_API_URL}/api/admission/procedure-and-fee/about/${editingAbout._id}`
        : `${process.env.NEXT_PUBLIC_API_URL}/api/admission/procedure-and-fee/about`;
