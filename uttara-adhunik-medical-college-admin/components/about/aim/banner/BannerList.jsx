...
export default function BannerList({ banner, onEdit, onDelete, isDeleting }) {
    ...
    return (
      <div className="text-center py-12 bg-gray-50 rounded-lg">
        <p className="text-gray-500 text-lg">
          No banner found. Add your first banner!
        </p>
      </div>
    );
  }
      ...
      {banner.map((banner) => (
        ...
        >
          ...
          <div className="relative h-48 w-full bg-gray-100">
            ...
            {banner.image?.includes("cloudinary") && (
          ...
          <div className="p-4">
            ...
            <div className="flex items-center justify-between text-xs text-gray-400 mb-4">
              <span>ID: {banner._id.slice(-6)}</span>
              <span>
