...
export default function VisitList({ visit, onEdit, onDelete, isDeleting }) {
  if (!visit) {
    return (
    ...
    return (
      <div className="text-center py-12 bg-gray-50 rounded-lg">
        <p className="text-gray-500 text-lg">
          No visit section found. Add your first visit section.
        </p>
      </div>
    );
  }
      ...
      {visit.map((visit) => (
        ...
        >
          ...
          <div className="p-4">
            ...
            {/* CTA Display */}
            {visit.cta && (visit.cta.text || visit.cta.href) && (
            ...
            <div className="flex items-center justify-between text-xs text-gray-400 mb-4">
              <span>ID: {visit._id.slice(-6)}</span>
              <span>
