...
import HeroList from "@/components/about/overview/hero/HeroList";
import { useHeroData } from "@/lib/DataFetch/About/Overview/SWRDataFetch";
import HeroForm from "@/components/about/overview/hero/HeroForm";
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/api/about/overview/hero/${id}`,
        {
          method: "DELETE",
        },
      );
  ...
  const handleSubmit = async (formData) => {
    ...
    try {
      const url = editingHero
        ? `${process.env.NEXT_PUBLIC_API_URL}/api/about/overview/hero/${editingHero._id}`
        : `${process.env.NEXT_PUBLIC_API_URL}/api/about/overview/hero`;
