...
import AboutList from "@/components/facility/laboratory/about/AboutList";
import { useLaboratoryData } from "@/lib/DataFetch/Facility/Laboratory/SWRDataFetch";
import AboutForm from "@/components/facility/laboratory/about/AboutForm";
import Modal from "@/components/ui/Modal";
import { toast } from "sonner";

export default function AboutManager() {
  const { data: about, mutate, isLoading } = useLaboratoryData();
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/api/facility/laboratory/about/${id}`,
        {
          method: "DELETE",
        },
      );
  ...
  const handleSubmit = async (formData) => {
    ...
    try {
      const url = editingAbout
        ? `${process.env.NEXT_PUBLIC_API_URL}/api/facility/laboratory/about/${editingAbout._id}`
        : `${process.env.NEXT_PUBLIC_API_URL}/api/facility/laboratory/about`;
