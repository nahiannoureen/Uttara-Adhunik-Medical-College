...
export default function AboutManager() {
  const { data: about, mutate, isLoading } = useTrainingData();
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/api/facility/training/about/${id}`,
        {
          method: "DELETE",
        },
      );
  ...
  const handleSubmit = async (formData) => {
    ...
    try {
      const url = editingAbout
        ? `${process.env.NEXT_PUBLIC_API_URL}/api/facility/training/about/${editingAbout._id}`
        : `${process.env.NEXT_PUBLIC_API_URL}/api/facility/training/about`;
      ...
      toast.success(
        editingAbout
          ? "Training Facilities Section updated successfully!"
          : "Training Facilities Section added successfully!",
      );
      mutate(); // Refresh the data
