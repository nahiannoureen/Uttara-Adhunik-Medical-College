...
import HeroList from "@/components/facility/hospital/hero/HeroList";
import { useHeroData } from "@/lib/DataFetch/Facility/Hospital/SWRDataFetch";
import HeroForm from "@/components/facility/hospital/hero/HeroForm";
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/api/facility/hospital/hero/${id}`,
        {
          method: "DELETE",
        },
      );
  ...
  const handleSubmit = async (formData) => {
    ...
    try {
      const url = editingHero
        ? `${process.env.NEXT_PUBLIC_API_URL}/api/facility/hospital/hero/${editingHero._id}`
        : `${process.env.NEXT_PUBLIC_API_URL}/api/facility/hospital/hero`;
